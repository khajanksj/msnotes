...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { is_active: @subject.is_active, subject: @subject.subject } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { is_active: @subject.is_active, subject: @subject.subject } }
